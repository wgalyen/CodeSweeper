...
fn make_ui() -> impl Widget<AppData> {
...

    {
        ...
        root.add_child(
            Label::new("See the source, report a bug, or contribute at https://github.com/wgalyen/codesweeper").text_size(18.0).padding(10.0).center(),0.0
        )
    }
